...
export function createLabPanel({ params, onReset, onPreset, onModeChange, onPauseChange }) {
  ...
  const state = {
    ...
    whiteShaderEnabled: params.whiteShaderEnabled.value
  };
  ...
  refreshers.push(rangeRow(force, 'radialStrength', state, 'radialStrength', -800, 800, 0.05, (v) => params.radialStrength.value = v, () => params.radialStrength.value));
  ...
  refreshers.push(rangeRow(force, 'vortexStrength', state, 'vortexStrength', -800, 800, 0.05, (v) => params.vortexStrength.value = v, () => params.vortexStrength.value));
  ...
  refreshers.push(rangeRow(force, 'dragCoefficient', state, 'dragCoefficient', 0, 10, 0.01, (v) => params.dragCoefficient.value = v, () => params.dragCoefficient.value));
  ...
  refreshers.push(rangeRow(force, 'wind.x', state, 'windX', -400, 400, 0.05, (v) => params.wind.value.x = v, () => params.wind.value.x));
  refreshers.push(rangeRow(force, 'wind.y', state, 'windY', -400, 400, 0.05, (v) => params.wind.value.y = v, () => params.wind.value.y));
  refreshers.push(checkRow(force, 'whiteShaderEnabled', params.whiteShaderEnabled.value > 0, (v) => params.whiteShaderEnabled.value = v ? 1 : 0, () => params.whiteShaderEnabled.value > 0));
  //refreshers.push(rangeRow(force, 'whiteShaderEnabled', state, 'whiteShaderEnabled', 0, 1, 1, (v) => params.whiteShaderEnabled.value = v, () => params.whiteShaderEnabled.value));
