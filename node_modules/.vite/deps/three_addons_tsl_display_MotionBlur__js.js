import { _ as Loop, ad as uv, kr as float, p as Fn, yi as int } from "./three.tsl-596YVWnh.js";
//#region node_modules/three/examples/jsm/tsl/display/MotionBlur.js
/**
...
*/
var motionBlur = /*@__PURE__*/ Fn(([inputNode, velocity, numSamples = int(16)]) => {
	...
	Loop({
		...
		const offset = velocity.mul(float(i).div(fSamples.sub(1)).sub(.5));
